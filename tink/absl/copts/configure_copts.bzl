...
load(
    "//tink/absl:copts/GENERATED_copts.bzl",
    "ABSL_CLANG_CL_FLAGS",
...
ABSL_DEFAULT_COPTS = select({
    "//tink/absl:msvc_compiler": ABSL_MSVC_FLAGS,
    "//tink/absl:clang-cl_compiler": ABSL_CLANG_CL_FLAGS,
    "//tink/absl:clang_compiler": ABSL_LLVM_FLAGS,
    "//tink/absl:gcc_compiler": ABSL_GCC_FLAGS,
    "//conditions:default": ABSL_GCC_FLAGS,
})

ABSL_TEST_COPTS = select({
    "//tink/absl:msvc_compiler": ABSL_MSVC_TEST_FLAGS,
    "//tink/absl:clang-cl_compiler": ABSL_CLANG_CL_TEST_FLAGS,
    "//tink/absl:clang_compiler": ABSL_LLVM_TEST_FLAGS,
    "//tink/absl:gcc_compiler": ABSL_GCC_TEST_FLAGS,
    "//conditions:default": ABSL_GCC_TEST_FLAGS,
})

ABSL_DEFAULT_LINKOPTS = select({
    "//tink/absl:msvc_compiler": ABSL_MSVC_LINKOPTS,
    "//conditions:default": [],
})
