...
#ifndef TINK_SUBTLE_AES_CMAC_WOLFSSL_H_
#define TINK_SUBTLE_AES_CMAC_WOLFSSL_H_
...
class AesCmacWolfssl : public Mac {
 public:
 ...
 private:
  AesCmacWolfssl(util::SecretData key, uint32_t tag_size)
...
#endif  // TINK_SUBTLE_AES_CMAC_WOLFSSL_H_
